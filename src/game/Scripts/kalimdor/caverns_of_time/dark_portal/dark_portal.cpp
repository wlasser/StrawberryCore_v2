...
struct npc_time_riftAI : public ScriptedAI
{
    ...
    void DoSelectSummon()
    {
        ...
        debug_log("SSC: npc_time_rift: summoning wave creature (Wave %u, Entry %u).", mRiftWaveCount, entry);
    ...
    void UpdateAI(const uint32 diff)
    {
        ...
        debug_log("SSC: npc_time_rift: not casting anylonger, i need to die.");
