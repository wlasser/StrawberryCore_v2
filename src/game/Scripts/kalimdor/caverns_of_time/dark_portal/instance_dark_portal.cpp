    ...
    switch(uiType)
    {
        case TYPE_MEDIVH:
            ...
            else
            {
                ...
                {
                    debug_log("SSC: Instance Dark Portal: Starting event.");
                    InitWorldState();
                ...
                if (uiData == DONE)
                {
                    ...
                    debug_log("SSC: Instance Dark Portal: Event completed.");
...
Creature* instance_dark_portal::SummonedPortalBoss(Creature* pSource)
{
    ...
    debug_log("SSC: Instance Dark Portal: Summoning rift boss uiEntry %u.", uiEntry);
    ...
    debug_log("SSC: Instance Dark Portal: what just happened there? No boss, no loot, no fun...");
    return NULL;
}
...
void instance_dark_portal::DoSpawnPortal()
{
    if (Creature* pMedivh = GetSingleCreatureFromStorage(NPC_MEDIVH))
    {
        ...
        debug_log("SSC: Instance Dark Portal: Creating Time Rift at locationId %i (old locationId was %u).", uiTmp, m_uiCurrentRiftId);
