...
{
    debug_log("SSC: Instance Ahn'Kahet: SetData received for type %u with data %u", uiType, uiData);
    ...
    switch(uiType)
    {
        ...
        default:
            error_log("SSC: Instance Ahn'Kahet: ERROR SetData = %u for type %u does not exist/not implemented.", uiType, uiData);
            break;
    }
