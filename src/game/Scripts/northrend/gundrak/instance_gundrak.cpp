...
{
    debug_log("SSC: Instance Gundrak: SetData received for type %u with data %u", uiType, uiData);
    ...
    switch(uiType)
    {
        ...
        case TYPE_ECK:
            ...
            break;
        default:
            error_log("SSC: Instance Gundrak: ERROR SetData = %u for type %u does not exist/not implemented.", uiType, uiData);
            return;
    }
