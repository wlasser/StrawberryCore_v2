...
enum SplineFlags
{
    ...
    SPLINEFLAG_TRAJECTORY = 0x00000100,
    SPLINEFLAG_WALKMODE       = 0x00000200,
    SPLINEFLAG_FLYING         = 0x00000400,
    SPLINEFLAG_FIXED_ORIENTATION = 0x00000800,
    SPLINEFLAG_FINAL_POINT = 0x00001000,
    SPLINEFLAG_FINAL_TARGET = 0x00002000,
    SPLINEFLAG_FINAL_ORIENTATION = 0x00004000,
    SPLINEFLAG_CATMULL_ROM = 0x00008000,
    SPLINEFLAG_CYCLIC = 0x00010000,
    SPLINEFLAG_ENTER_CICLE = 0x00020000,
    SPLINEFLAG_ANIMATION_TIER = 0x00040000,
    SPLINEFLAG_FROZEN = 0x00080000,
    SPLINEFLAG_UNK = 0x00100000,
    SPLINEFLAG_UNK1 = 0x00200000,
    SPLINEFLAG_UNK2 = 0x00400000,
    SPLINEFLAG_UNK3 = 0x00800000,
    SPLINEFLAG_UNK4 = 0x01000000,
    SPLINEFLAG_UNK5 = 0x02000000,
    SPLINEFLAG_MOVING_BACKWARDS = 0x04000000,
    SPLINEFLAG_USE_PATH_SMOOTHING = 0x08000000,
    SPLINEFLAG_ANIMATION = 0x10000000,
    SPLINEFLAG_UNCOMPRESSED_PATH = 0x20000000,
    SPLINEFLAG_UNK6 = 0x40000000,
    SPLINEFLAG_UNK7 = 0x80000000,
