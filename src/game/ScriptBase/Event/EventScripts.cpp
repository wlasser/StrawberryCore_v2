...
void EventScripts::LoadScripts(ScriptMapMap& scripts, const char* tablename)
{
...
void EventScripts::CheckScriptTexts(ScriptMapMap const& scripts, std::set<int32>& ids)
{
